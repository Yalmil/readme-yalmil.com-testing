...
<h2>:brain: Sobre Yalmil.com</h2>
<ul>
  <li>:man_technologist: Es desarrollado por YDT.</li>
  <li>:video_game: Tiene más de 4 juegos actualemente.</li>
  <li>:package: Cuenta con soporte para todas las plataformas.</li>
</ul>
